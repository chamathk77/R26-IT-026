        ...
        <Table>
          <TableHead>
            <TableRow sx={{ bgcolor: 'grey.50' }}>
              ...
              <TableCell sx={{ fontWeight: 700 }}>Plan change</TableCell>
            ...
            {loading ? (
              ...
              payments.map((payment) => (
                ...
                >
                  ...
                  <TableCell>{formatSubscriptionTypeLabel(payment.subscriptionType)}</TableCell>
                  <TableCell>
                    {payment.isSubscriptionChangePending === true ||
                    payment.shop?.isSubscriptionChangePending === true ? (
                      <Chip
