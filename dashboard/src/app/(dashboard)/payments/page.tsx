...
const PAYMENT_SECTIONS = [
  {
    ...
    description: 'Record manual upfront payments and generate printable confirmation receipts.',
    href: '/payments/upfront-confirmation',
    ...
    <DashboardShell title="Payments" subtitle="Choose a payment category to review">
      <Grid container spacing={3}>
        {PAYMENT_SECTIONS.map((section) => {
          ...
          return (
            <Grid key={section.href} size={{ xs: 12, sm: 6, lg: 3 }}>
              <Card
                component={Link}
                href={section.href}
                sx={{
