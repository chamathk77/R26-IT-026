...
const SHOP_SECTIONS = [
  {
    title: 'Active shops',
    description:
      'View shops that are active, due, payment pending, or in subscription payment flow.',
    href: '/shops/active',
  ...
  {
    title: 'Trial',
    description: 'Manage shops on trial or with an expired trial period.',
    href: '/shops/trial',
    icon: HourglassTopOutlinedIcon,
    gradient: 'linear-gradient(135deg, #7b1fa2 0%, #e65100 100%)',
  },
] as const;
