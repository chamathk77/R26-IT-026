...
import { fetchTrialShopDetails } from '@/lib/api/shops';
...
export default function TrialShopBulkUploadPage() {
    ...
    >
      ...
      >
        <Button
          ...
          onClick={() => router.push(`/shops/trial/${encodeURIComponent(shopId)}`)}
        >
          Back to trial shop
        </Button>
      </Box>
