...
function ownerName(shop: OnboardUserSummary): string {
  return [shop.ownerFirstName, shop.ownerLastName].filter(Boolean).join(' ') || '—';
}

function shopInitials(shop: OnboardUserSummary): string {
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ bgcolor: 'grey.50' }}>
                ...
                <TableCell sx={{ fontWeight: 700 }}>Shop mobile</TableCell>
              ...
              {loading ? (
                ...
                shops.map((shop) => (
                  ...
                  >
                    ...
                    <TableCell>{shop.shopMobileNumber || '—'}</TableCell>
