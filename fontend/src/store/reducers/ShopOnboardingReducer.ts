...
interface ShopOnboardingState {
  ...
  selectNewSubscription: {
    ...
    error: string | null;
    success: boolean;
    data: SelectNewSubscriptionResponse | null;
  };
  subscriptionPlans: {
    loading: boolean;
    error: string | null;
...
export const ShopOnboardingSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(selectNewSubscription_Service.pending, (state) => {
      state.selectNewSubscription.loading = true;
      state.selectNewSubscription.error = null;
      state.selectNewSubscription.success = false;
    });
    builder.addCase(selectNewSubscription_Service.fulfilled, (state, action) => {
      state.selectNewSubscription.loading = false;
      state.selectNewSubscription.success = true;
      state.selectNewSubscription.error = null;
      state.selectNewSubscription.data = action.payload;
    });
    builder.addCase(selectNewSubscription_Service.rejected, (state, action) => {
      state.selectNewSubscription.loading = false;
      state.selectNewSubscription.success = false;
      state.selectNewSubscription.error =
        (action.payload as string) ||
        action.error.message ||
        'Subscription plan selection failed';
      state.selectNewSubscription.data = null;
    });
    ...
    builder.addCase(manageSmsFeature_Service.pending, (state) => {
      state.manageSmsFeature.loading = true;
      state.manageSmsFeature.error = null;
      state.manageSmsFeature.success = false;
    });
    builder.addCase(manageSmsFeature_Service.fulfilled, (state, action) => {
      state.manageSmsFeature.loading = false;
      state.manageSmsFeature.success = true;
      state.manageSmsFeature.error = null;
      state.manageSmsFeature.data = action.payload;
      state.shopSmsFeatures.data = {
    ...
    builder.addCase(manageSmsFeature_Service.rejected, (state, action) => {
      state.manageSmsFeature.loading = false;
      state.manageSmsFeature.success = false;
