...
interface CommonAlertProps {
    ...
    onClose?: () => void;
    /** When false, tapping outside the alert does not close it. Default: true */
...
const CommonAlert: React.FC<CommonAlertProps> = ({
    ...
    return (
        <Modal
            visible={visible}
            dismissable={closeOnBackdropPress}
            dismissableBackButton={closeOnBackdropPress}
            onDismiss={closeOnBackdropPress ? onClose : undefined}
