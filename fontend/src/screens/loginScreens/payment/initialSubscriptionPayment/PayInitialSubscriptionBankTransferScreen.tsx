...
type Props = NativeStackScreenProps<
  RootStackParamList,
  'PayInitialSubscriptionBankTransferScreen'
>;
...
export default function PayInitialSubscriptionBankTransferScreen({ navigation, route }: Props) {
    ...
    try {
      ...
      setTimeout(() => {
        show_Alert(
          ...
          'OK',
          () => {
            navigation.navigate('PayInitialSubscriptionScreen');
          },
        );
      }, 150);
    } catch (error: unknown) {
