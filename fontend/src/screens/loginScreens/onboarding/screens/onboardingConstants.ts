...
export type IndustryTypeOption = {
  id: IndustryType;
  title: string;
  description: string;
  icon: string;
...
export const INDUSTRY_TYPE_OPTIONS: IndustryTypeOption[] = [
  {
    id: 'retail',
    title: 'General shop',
    description: 'Retail and other standard businesses',
    icon: 'storefront-outline',
  },
  {
    id: 'restaurant',
    title: 'Restaurant',
    description: 'Tables, kitchen orders, and menu service',
