...
import { IndustryType } from '../../../../type/onboarding';
import { INDUSTRY_TYPE_OPTIONS } from './onboardingConstants';
import {
            ...
            <View style={cardStyle}>
              ...
              <View style={styles.industryGrid}>
                {INDUSTRY_TYPE_OPTIONS.map((option) => {
                  const isSelected = industryType === option.id;
                  return (
                    <TouchableOpacity
                      key={option.id}
                      style={[
                      ...
                      onPress={() => setIndustryType(option.id)}
                      activeOpacity={0.85}
                    >
                      <Ionicons
                      ...
                      <Text
                        style={[
                          styles.industryOptionDescription,
                          {
                            color: isSelected
                              ? paperTheme.colors.onPrimaryContainer
                              : paperTheme.colors.onSurfaceVariant,
