        ...
        >
          ...
          >
            ...
            {!isSubmitted ? (
              <View
                style={[
                  screenStyles.pendingSubmissionBanner,
                  {
                    backgroundColor:
                      resolvedTheme === 'dark' ? 'rgba(245, 158, 11, 0.12)' : '#fff7ed',
                    borderColor: '#fb923c',
                  },
                ]}
              >
                <Ionicons name="alert-circle-outline" size={18} color="#c2410c" />
                <Text style={screenStyles.pendingSubmissionText}>
                  Receipt not submitted yet. Your submitted date will appear after you upload
                  and send this payment.
                </Text>
              </View>
            ) : null}
          </View>
          ...
          >
            ...
            <SettingsDetailRow
              ...
              paperTheme={paperTheme}
              valueColor={isSubmitted ? undefined : '#b45309'}
            />
            <SettingsDetailRow
