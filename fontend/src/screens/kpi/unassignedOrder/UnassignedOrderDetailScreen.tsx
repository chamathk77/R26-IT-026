  ...
  const handleConfirmAssign = async () => {
    ...
    try {
      ...
      show_Alert(
        'success',
        'Assigned',
        `${selectedPersonName ?? 'Sales person'} has been assigned to ${orderId}.`,
        1,
        false,
        'OK',
        () => {
      ...
      >
        ...
        {detailLoading && !detail ? (
          <View style={pickerStyles.centered}>
            ...
            <Text style={[pickerStyles.loadingText, { color: paperTheme.colors.onSurfaceVariant }]}>
          ...
          <>
            <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
              ...
              >
                ...
                >
                  {checkOutLabel} · Cart #{detail.cartNumber}
                </Text>
