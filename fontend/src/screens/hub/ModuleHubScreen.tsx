  ...
  return (
    <>
      ...
      >
        ...
        >
          <View
            style={[styles.iconWrap, { backgroundColor: paperTheme.colors.primaryContainer }]}
          >
            <Ionicons name="cart" size={32} color={paperTheme.colors.primary} />
          </View>
        ...
        >
          <View
            style={[styles.iconWrap, { backgroundColor: paperTheme.colors.tertiaryContainer }]}
          >
            <Ionicons name="analytics" size={32} color={paperTheme.colors.tertiary} />
          </View>
          <View style={styles.cardText}>
            <Text style={[styles.cardTitle, { color: paperTheme.colors.onSurface }]}>
