...
import {
  CostCategoryModalSkeleton,
  CostHistoryListSkeleton,
} from '../../shared/costSkeletonComponents';
  ...
  return (
    <>
      <FlatList
        ...
        data={showListSkeleton ? [] : sortedItems}
        ...
        <Pressable style={modalStyles.modalBackdrop} onPress={() => setCategoryModalVisible(false)}>
          ...
          >
            ...
            {categoriesLoading && categories.length === 0 ? (
              <CostCategoryModalSkeleton boneColor={paperTheme.colors.surfaceVariant} />
            ) : (
              <FlatList
