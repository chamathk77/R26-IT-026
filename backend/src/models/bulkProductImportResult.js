...
const bulkImportFailedRowSchema = new mongoose.Schema(
  {
    ...
    warrantyAvailable: { type: mongoose.Schema.Types.Mixed, default: '' },
...
const bulkImportImportedProductSchema = new mongoose.Schema(
  {
    id: {
      type: mongoose.Schema.Types.ObjectId,
      required: true,
...
const bulkProductImportResultSchema = new mongoose.Schema(
  {
    ...
    importedProducts: {
      type: [bulkImportImportedProductSchema],
      default: [],
    },
    failedRows: {
